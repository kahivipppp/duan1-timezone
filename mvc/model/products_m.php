...
function showsp($dssp){
    ...
    foreach ($dssp as $sp) {
        ...
        if($bestseller==1){
            ...
            $best='<div class="product_item"></div>';
        }else{
            $best='';
        }
        ...
        $html_splist.='<div class="col-lg-4 col-md-6 col-sm-6">
            '.$best.'
            <div class="product__item__pic set-bg" data-setbg="../public/img/product/'.$img.'">
                <ul class="product__hover">
                    <li><a href="index.php?pg=sanphamchitiet&id='.$id.'"><img src="../public/img/icon/heart.png" alt=""></a></li>
                    <li><a href="index.php?pg=sanphamchitiet&id='.$id.'"><img src="../public/img/icon/compare.png" alt=""> <span>Compare</span></a>
                    </li>
                    <li><a href="index.php?pg=sanphamchitiet&id='.$id.'"><img src="../public/img/icon/search.png" alt=""></a></li>
                </ul>
            </div>
