<!-- Header Section End -->
    ...
    <section class="hero">
        <div class="hero__slider owl-carousel">
            <div class="hero__items set-bg" data-setbg="../public/img/hero/hero-3.jpg">
                <div class="container">
                    <div class="row">
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="instagram__text">
                        <h2>Instagram</h2>
                        <p>Đồng hồ không phải chỉ đề xem giờ mà nó còn mang lại cho bạn nhiều giá trị hơn thế.</p>
                        <h3>#Timezone</h3>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5>Chúng tôi là ai ?</h5>
                            <span>Các chương trình quảng cáo theo ngữ cảnh đôi khi cũng có những chính sách nghiêm ngặt cần được tuân thủ. Hãy lấy Google làm ví dụ.</span>
                            <a href="#">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5>Chúng tôi làm gì ?</h5>
                            <span>Trong thế hệ kỹ thuật số này, nơi có thể dễ dàng lấy được thông tin trong vòng vài giây, danh thiếp vẫn giữ được tầm quan trọng của chúng.</span>
                            <a href="#">Read More</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        ...
                        <div class="blog__item__text">
                            ...
                            <h5>Tại sao chọn chúng tôi ?</h5>
                            <span>Một ngôi nhà hai hoặc ba tầng là cách lý tưởng để tận dụng tối đa mảnh đất mà ngôi nhà của chúng ta tọa lạc, nhưng dành cho những người già hoặc ốm yếu.</span>
                            <a href="#">Read More</a>
                        </div>
