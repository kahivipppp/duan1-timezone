            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <div class="shop__product__option__left">
                                    <p>Hiển thị 1–12 trong tất cả 126 sản phẩm</p>
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <div class="row">
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="../public/img/product/product-2.jpg">
                                    <ul class="product__hover">
                                        ...
                                        <li><a href="#"><img src="../public/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="../public/img/product/product-13.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="../public/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="../public/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6">
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="../public/img/product/product-14.jpg">
                                    <ul class="product__hover">
                                        <li><a href="#"><img src="../public/img/icon/heart.png" alt=""></a></li>
                                        <li><a href="#"><img src="../public/img/icon/compare.png" alt=""> <span>Compare</span></a>
                                        </li>
